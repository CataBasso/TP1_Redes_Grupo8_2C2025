        ...
        try:
            with open(self.args.src, "rb") as file:
                ...
                while bytes_sent < file_size:
                    while (
                        next_seq_num < base_num + window_size and bytes_sent < file_size
                    ):
                    ...
                    try:
                        ...
                        if response.startswith("ACK:"):
                            ...
                            if ack_seq in pkts:
                                ...
                                if ack_seq == base_num:
                                    while (
                                        base_num not in pkts and base_num < next_seq_num
                                    ):
                                        base_num += 1
        ...
        with open(file_path, "wb") as recieved_file:
            while bytes_received < filesize:
                ...
                if seq_received == seq_expected:
                    ...
                    print(
                        f"Received packet {seq_received}, expected {seq_expected} - queuing"
                    )
